...
<div class="sortable row-fluid">
    ...
    <div class="box1 span4">
        ...
        <table>
            <a href="#">
                <h2 align="center"><u>Professional Development Event</u></h2></a>
        </table>
    ...
    <div class="box span6">
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label" for="date01">Summary</label>
                    <div class="controls">
                        <input type="text" class="title" id="title" >
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="date01">Hours</label>
                    <div class="controls">
                        <input type="text" class="title" id="title" >
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="date01">Minutes</label>
                    <div class="controls">
                        <input type="text" class="title" id="title" >
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="date01">Tolat Time</label>
                    <div class="controls">
                        <input type="text" class="title" id="title" >
                    </div>
                </div>
